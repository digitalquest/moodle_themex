...
<div id="page" class="container-fluid">
  ...
  <i class="fa fa-exclamation-triangle fa-lg"></i><strong> Please Note:</strong> This course is currently hidden from students. You can make the course visible via the <a class="warn_link" href="/course/edit.php?id='.$COURSE->id.'"><strong> course settings</strong></a>.</div>';
    }
    ?>
